...
const translations = {
  zh: {
    ...
    suggestTasksDesc: "在专注事项输入时可联想的任务列表（最多100行）。每行限制：100个英文字符或50个其他字符。超过100行则无法继续输入。",
  ...
  en: {
    ...
    suggestTasksDesc: "Task list for autocomplete when entering focus items (max 100 lines). Each line limit: 100 ASCII characters or 50 other characters. Cannot input more than 100 lines.",
