...
const translations = {
  zh: {
    ...
    defaultRestMinutesDesc: "设置默认的休息时长，不填写时默认为5分钟。只接受正整数，最大600。",
    quickTimer: "快捷Timer",
  ...
  en: {
    ...
    defaultRestMinutesDesc: "Set the default rest duration. Defaults to 5 minutes if empty. Only accepts positive integers, max 600.",
